...
class TestSwift(unittest.TestCase):
    ...
    def test_target_type_uri(self):
        stimuli = [
            {
                'request': fake.create_request(path='/v1/AUTH_0123456789/containername/testfile'),
                'expected': 'service/storage/object/account/container/object'
            },
            {
                'request': fake.create_request(path='/v1/AUTH_foobar/containername/testfile'),
                'expected': 'service/storage/object/account/container/object'
            },
            {
                'request': fake.create_request(path='/v1/AUTH_0123456789/containername'),
            ...
            {
                'request': fake.create_request('/v1/endpoints'),
                'expected': 'service/storage/object/endpoints'
            },
            {
                'request': fake.create_request('/info'),
